<template>
	<section id="skills" class="flex flex-col justify-around">
		...
		<!-- <p class="py-2">
			...
			praesentium aperiam sed earum, corporis pariatur expedita ullam iusto iste! Facilis incidunt, numquam
			aliquam nihil est voluptatibus.
		</p> -->
		<SkillCloud />
	</section>
</template>
