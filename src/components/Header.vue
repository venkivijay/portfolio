    ...
    <nav class="nav">
      ...
      <div class="right" print:op0>
        ...
        <RouterLink to="/chat" title="Chat">
          <span class="lt-md:hidden">Chat</span>
          <div i-ri:chat-1-line md:hidden />
        </RouterLink>
        <a href="https://github.com/venkivijay" target="_blank" title="GitHub" class="lt-md:hidden">
          <div i-uil-github-alt />
        </a>
        <a href="https://linkedin.com/in/venkivijay" target="_blank" title="LinkedIn" class="lt-md:hidden">
          <div i-uil-linkedin />
        </a>
        <ToggleTheme />
      </div>
